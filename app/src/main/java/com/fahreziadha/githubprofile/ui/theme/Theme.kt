...
private val LightColorPalette = GithubProfileColors(
    brand = Shadow5,
...
private val DarkColorPalette = GithubProfileColors(
    brand = Shadow1,
...
fun GithubProfileTheme(
    ...
    ProvideGithubProfileColors(colors){
        MaterialTheme(
...
@Composable
fun ProvideGithubProfileColors(
    colors: GithubProfileColors,
    content: @Composable () -> Unit
) {
    ...
    CompositionLocalProvider(LocalGithubProfileColors provides colorPalette, content = content)
}

private val LocalGithubProfileColors = staticCompositionLocalOf<GithubProfileColors> {
    error("No GithubProfileColorPallate provided")
}

object GithubProfileTheme{
    val colors: GithubProfileColors
        @Composable
        get() = LocalGithubProfileColors.current
}
...
class GithubProfileColors(
    ...
    fun update(other: GithubProfileColors) {
    ...
    fun copy(): GithubProfileColors = GithubProfileColors(
